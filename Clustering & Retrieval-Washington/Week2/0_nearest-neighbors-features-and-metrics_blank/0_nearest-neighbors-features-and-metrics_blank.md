...
```
    ...
    [INFO] graphlab.cython.cy_server: GraphLab Create v1.10.1 started. Logging: /tmp/graphlab_server_1471074130.log
...
<pre>| 0            | 1       | 0.00169288  | 4.133ms      |</pre>



<pre>| Done         |         | 100         | 212.745ms    |</pre>
...
```python
print graphlab.toolkits.distances.euclidean(wiki[wiki['name']=='Barack Obama']['word_count'][0],wiki[wiki['name']=='George W. Bush']\
                                      ['word_count'][0])
print graphlab.toolkits.distances.euclidean(wiki[wiki['name']=='Barack Obama']['word_count'][0],wiki[wiki['name']=='Joe Biden']\
                                      ['word_count'][0])
print graphlab.toolkits.distances.euclidean(wiki[wiki['name']=='Joe Biden']['word_count'][0],wiki[wiki['name']=='George W. Bush']\
                                      ['word_count'][0])
```
...
Combined = Obama.join(Bush,on='word')
Combined = Combined.rename({'count':'Obama','count.1':'Bush'})
```


```python
Combined.sort('Obama',False)
```
...
<pre>| 0            | 1       | 0.00169288  | 7.515ms      |</pre>



<pre>| Done         |         | 100         | 303.683ms    |</pre>
...
combine_tf_idf = combine_tf_idf.rename({'weight':'Obama','weight.1':'Schiliro'})
combine_tf_idf.sort('Obama',False)
```
...
```python
common_words = set(combine_tf_idf['word'][0:5])  # YOUR CODE HERE
...
```python
graphlab.toolkits.distances.euclidean(wiki[wiki['name']=='Barack Obama']['tf_idf'][0],wiki[wiki['name']=='Joe Biden']\
                                     ['tf_idf'][0])
```
...
<pre>| 0            | 1       | 0.00169288  | 13.12ms      |</pre>



<pre>| Done         |         | 100         | 327.972ms    |</pre>
...
<pre>| 0            | 1       | 0.00169288  | 7.188ms      |</pre>



<pre>| Done         |         | 100         | 283.145ms    |</pre>
...
```
    ...
    <matplotlib.figure.Figure at 0x7fc070395a90>
...
<pre>| 0            | 1       | 0.00169288  | 18.556ms     |</pre>



<pre>| Done         |         | 100         | 276.423ms    |</pre>
