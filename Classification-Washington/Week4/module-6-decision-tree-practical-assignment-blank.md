...
```python
print evaluate_classification_error(model_7,validation_set)
print evaluate_classification_error(model_8,validation_set)
print evaluate_classification_error(model_9,validation_set)
```
