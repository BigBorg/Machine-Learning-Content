...
for model in [model_10,model_50,model_100,model_200,model_500]:
    print model.evaluate(validation_data)['accuracy']
```
...
validation_errors = []
for model in [model_10,model_50,model_100,model_200,model_500]:
    training_errors.append(1-model.evaluate(train_data)['accuracy'])
    validation_errors.append(1-model.evaluate(validation_data)['accuracy'])
```
